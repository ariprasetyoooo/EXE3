...
namespace EXE3
{
    public partial class Form3 : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            form_4.NIMmhs.Text = this.dataGridView1.CurrentRow.Cells[0].Value.ToString();
            form_4.NmMhs.Text = this.dataGridView1.CurrentRow.Cells[1].Value.ToString();
            form_4.AlmMhs.Text = this.dataGridView1.CurrentRow.Cells[2].Value.ToString();
            form_4.SexMhs.Text = this.dataGridView1.CurrentRow.Cells[3].Value.ToString();
            form_4.PhoneMhs.Text = this.dataGridView1.CurrentRow.Cells[4].Value.ToString();
